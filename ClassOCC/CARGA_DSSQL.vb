...
Public Class carga_dssql
    ...
    'Private dssai As New DataGeneral
...
#Region "ParametrosAPP"
    ...
    Private Sub escribir_xml(tb)
        ...
        ds.WriteXml(X)
    End Sub
    Public ReadOnly Property dtparametros As DataTable
        Get
            carga_xmlp("ParametrosAPP")
            Return ds.Tables("ParametrosAPP")
        End Get
    End Property
    Public Sub addparametro(valor1 As String, valor2 As String, valor3 As String)
...
#End Region
    ...
    Private Function ruta() As String
        Dim iplocal As String = context.Request.UserHostAddress
        If iplocal = "127.0.0.1" Or iplocal = "::1" Or iplocal.Contains("192.168.") = True Then
            Return ConfigurationManager.ConnectionStrings("GLConnectionString1").ToString
        Else
            Return ConfigurationManager.ConnectionStrings("GLConnectionString").ToString
        End If
    ...
    Public Function pivot_1tb(campos As String, campo_pivot As String, campo_for As String, colum_resultado As String, Optional criterio As String = Nothing, Optional grupo As Boolean = False, Optional orden As String = Nothing) As DataTable
        ...
        Return ds.Tables("tbpivot")
    End Function
    Public Sub txtError(er As Exception)
        Try
