...
Public Class ClassConstructor22
    ...
    Private Shared fr_consulta, fr_BtGUARDAR, FrSUP, MnFR As Boolean
...
#End Region
    ...
    Public Sub FORMULARIO(titulo As String, campos As String, Optional BtGUARDAR As Boolean = False, Optional FrSUPERIOR As Boolean = False, Optional It_MENU As String = Nothing, Optional col_fr As Color = Nothing)
    ...
    Private Sub carga_menu(Optional sup As Boolean = False)
        ...
        If it_mn IsNot Nothing Then
            If sup = True Then
                FR.Controls.Add(MN("MnPRINCIPAL"))
            Else

            End If
            Dim men As Menu
            Try
                men = FR.FindControl("MnPRINCIPAL")
            Catch ex As Exception
            ...
            If men IsNot Nothing Then
                ...
                men.StaticMenuItemStyle.ForeColor = Color.Black
                ...
                men.StaticMenuItemStyle.BackColor = COLOR_MN
            ...
            'FR.Controls.Add(MN("MnSEGUNDARIO"))
            'Dim men2 As Menu = FR.FindControl("MnSEGUNDARIO")
            'men2.Orientation = Orientation.Horizontal
            'men2.Width = Unit.Percentage(100)
            'men2.StaticMenuItemStyle.ForeColor = Color.White
            'men2.StaticMenuItemStyle.Font.Size = FontUnit.Point(size_fuente)
            'men2.StaticMenuItemStyle.BorderColor = Color.White
            'men2.StaticMenuItemStyle.BorderWidth = Unit.Point(2)
            'men2.StaticMenuItemStyle.BackColor = col_fr
            'If men2.Items.Count = 0 Then
            '    For Each STR As String In it_mn.Split(",")
            '        Dim MI As New MenuItem
            '        MI.Text = STR.Replace("_", " ").ToUpper
            '        men2.Items.Add(MI)
            ...
            '    AddHandler men2.MenuItemClick, AddressOf clic_mn
            'End If


            'men.BackColor = Color.DarkBlue
    ...
    Public Sub FORMULARIO_GR(Titulo As String, id As String, titulo_campos As String, Item_mn As String, Optional db As String = Nothing, Optional criterio As String = Nothing, Optional evento As EventHandler = Nothing, Optional filtros As String = Nothing, Optional orden As String = Nothing, Optional dt_grid As DataTable = Nothing)
        ...
        If Item_mn IsNot Nothing Then
            ...
            If Item_mn IsNot Nothing Then
                ...
                End If
                Dim men As Menu = FR.FindControl(id_ct)
                men.Orientation = Orientation.Horizontal
                men.Width = Unit.Percentage(100)
                ...
                men.StaticMenuItemStyle.BorderColor = Color.White
                men.StaticMenuItemStyle.BorderWidth = Unit.Point(2)
                men.StaticMenuItemStyle.BackColor = col_fr
                'men.BackColor = Color.DarkBlue
                If men.Items.Count = 0 Then
                    For Each STR As String In Item_mn.Split(",")
                        Dim MI As New MenuItem
                        MI.Text = STR.Replace("_", " ").ToUpper
                        men.Items.Add(MI)
                    Next
    ...
    Private Sub sel_drfiltro()
        ...
        carga_gr()
    End Sub
    Public Property FR_CONTROL(NOMBRE As String, Optional activo As Boolean = True, Optional db As DataTable = Nothing, Optional evento As EventHandler = Nothing, Optional col_txt As Color = Nothing, Optional post As Boolean = False, Optional focus As Boolean = False) As String
        Get
        ...
        Set(value As String)
            ...
            Select Case nombrect
                ...
                Case "Bt"
                    ...
                    If BtC IsNot Nothing And evento IsNot Nothing Then
...
#Region "CONTROLES"
    Private Function control_fr(nombre As String, Optional ancho As Integer = 98) As Control
        ...
        Dim namect As String = nombre.Remove(2)
        Select Case namect
            Case "Tx"
    ...
    Private Function Ti(ID As String, Optional texto As String = Nothing, Optional tamano As String = "1") As Literal
        ...
        End If
    End Function
    Private Function Tx(ID As String, Optional TipoTX As TextBoxMode = TextBoxMode.SingleLine, Optional ancho As Integer = 98, Optional texto As String = Nothing) As TextBox
        Tx = New TextBox
        If ID.Contains("=") = True Then
            Dim _ID As String() = ID.Split("=")
            Tx.Text = _ID(1)
    ...
    End Function
    Private Function Bi(Texto As String, Optional evento As ImageClickEventHandler = Nothing) As ImageButton
        Bi = New ImageButton
        Bi.ID = "Bi" + Texto.ToUpper
        Bi.ImageUrl = wcon.Server.MapPath("img\" + Bi.ID)
        Bi.AlternateText = Texto.ToUpper
        Bi.PostBackUrl = npg + "?fr=" + Texto.ToUpper
        Bi.Width = 30
        Bi.Height = 30
        If evento <> Nothing Then
            AddHandler Bi.Click, evento
        End If
    End Function
    Private Function Bt(Texto As String, Optional evento As EventHandler = Nothing) As Button
        ...
        'End If
    End Function
    Private Function IMG(ID As String, Optional TIPO As String = "jpg") As WebControls.Image
